...
<body class="bg-[#f8fafc] flex h-screen overflow-hidden text-slate-900 font-sans antialiased">
        ...
        <nav class="flex-grow px-6 space-y-1">
            ...
            @php
                $navItems = [
                    ...
                    ['route' => 'admin.schedules.index', 'label' => 'Events', 'icon' => 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z', 'roles' => [2,3]],
                ];
            @endphp
            ...
            <a href="{{ route('admin.announcements.index') }}" 
               ...
               {{ request()->routeIs('admin.announcements.*') ? 'bg-white/20 text-white shadow-lg backdrop-blur-md' : 'text-white/70 hover:bg-white/10 hover:text-white' }}">
                <div class="p-1.5 rounded-lg mr-3 transition-all duration-300 {{ request()->routeIs('admin.announcements.*') ? 'bg-white ' . $activeIconColor : $hoverIconClass }}">
            ...
            <a href="{{ route('admin.documents.index') }}"
               ...
               {{ request()->routeIs('admin.documents.*') ? 'bg-white/20 text-white shadow-lg backdrop-blur-md' : 'text-white/70 hover:bg-white/10 hover:text-white' }}">
                <div class="p-1.5 rounded-lg mr-3 transition-all duration-300 {{ request()->routeIs('admin.documents.*') ? 'bg-white ' . $activeIconColor : $hoverIconClass }}">
            ...
            <a href="{{ route('admin.verification.index') }}"
               ...
               {{ request()->routeIs('admin.verification.*') ? 'bg-white/20 text-white shadow-lg backdrop-blur-md' : 'text-white/70 hover:bg-white/10 hover:text-white' }}">
                <div class="p-1.5 rounded-lg mr-3 transition-all duration-300 {{ request()->routeIs('admin.verification.*') ? 'bg-white ' . $activeIconColor : $hoverIconClass }}">
            ...
            <div class="pt-4 pb-2">
                ...
                <a href="{{ route('admin.roles.index') }}"
                   ...
                   {{ request()->routeIs('admin.roles.*') ? 'bg-white/20 text-white shadow-lg backdrop-blur-md' : 'text-white/70 hover:bg-white/10 hover:text-white' }}">
                    <div class="p-1.5 rounded-lg mr-3 transition-all duration-300 {{ request()->routeIs('admin.roles.*') ? 'bg-white ' . $activeIconColor : $hoverIconClass }}">
                ...
                <a href="{{ route('admin.audit-logs.index') }}"
                   ...
                   {{ request()->routeIs('admin.audit-logs.*') ? 'bg-white/20 text-white shadow-lg backdrop-blur-md' : 'text-white/70 hover:bg-white/10 hover:text-white' }}">
                    <div class="p-1.5 rounded-lg mr-3 transition-all duration-300 {{ request()->routeIs('admin.audit-logs.*') ? 'bg-white ' . $activeIconColor : $hoverIconClass }}">
    ...
    <div class="flex-grow flex flex-col min-w-0">
        <header class="h-16 bg-white border-b border-slate-100 flex items-center justify-end px-8 z-20 shadow-sm">
            @php
