...
<div class="space-y-8 animate-fade-in max-w-[1600px] mx-auto">
    ...
    {{-- Document Request Activity Log --}}
    <div class="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-8 py-5 border-b border-gray-50 flex items-center justify-between">
            <div>
                <h2 class="text-sm font-extrabold text-gray-800 tracking-tight">Document Request Activity</h2>
                <p class="text-[10px] text-gray-400 font-medium mt-0.5 uppercase tracking-widest">Last 50 document request actions</p>
            </div>
        </div>

        @if($docAuditLogs->isEmpty())
            <div class="py-12 text-center">
                <p class="text-[10px] font-black text-gray-300 uppercase tracking-widest">No document request activity recorded yet</p>
            </div>
        @else
        <table class="w-full">
            <thead>
