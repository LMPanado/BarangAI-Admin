...
<div class="space-y-8 p-4">
    ...
    <div class="flex justify-between items-center border-b border-slate-100 pb-8">
        <div>
            <h1 class="text-3xl font-extrabold text-slate-800 tracking-tight">Add New Resident</h1>
            <p class="text-slate-500 text-sm mt-1 font-medium">Create a new profile for the <span class="text-brgyGreen font-bold">Barangay 419</span> database.</p>
        </div>
        <a href="{{ route('admin.residents.index') }}" class="text-[10px] font-black text-slate-400 hover:text-brgyGreen uppercase tracking-[0.2em] transition-all flex items-center gap-2">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="civil_status" class="w-full bg-slate-50 border-2 border-slate-50 rounded-2xl px-4 py-3 text-sm font-bold text-slate-700 focus:bg-white focus:border-brgyGreen focus:ring-0 outline-none transition-all appearance-none">
